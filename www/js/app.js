...
var starter = angular.module('starter', ['ionic',
                                        ...
                                        'starter.services',
                                        'starter.rolesroutes',
                                        'starter.profileRoutes',
                                        'starter.branchRoutes',
                                        'starter.contactroutes',
                                        'starter.productRoutes'])

.run(function(PopupFactory,apiUrlLocal,$http,$state,$localstorage,$translate,$cordovaNetwork,$ionicPopup,$ionicPlatform, $translate,$rootScope, $location) {  
...
.config(function($translateProvider) {
  ...
  $translateProvider.translations("en", {
    ...
    Save:"Save",
    ListEmpty:"No items, pull to refresh.",
    Registration:"Registration",
    RegisterConfirm:"Do you want to register to this event?",
    Information:"Info",
// new wwwwwwwwwww
    ...
    MessageRequired: "All fields are required.",
  ...
  $translateProvider.translations("es", {
    ...
    Save:"Guardar",
    ListEmpty:"No hay elementos, deslice para refrescar.",
    Registration:"Registro",
    RegisterConfirm:"¿Quiere registrarse para este evento?",
    Information:"Info",
    //new apppppppp
    ...
    MessageRequired: "Todos los campos son requeridos.",
  ...
  $translateProvider.translations("de", {
    ...
    RegisterConfirm:"Möchten Sie sich registrieren, um diese Veranstaltung?",
    Information:"Info",
    ...
    MessageRequired: "Alle Felder sind erforderlich.",
