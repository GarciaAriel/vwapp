angular.module('starter.contactDetail',['starter.contactservices','starter.constantscontact'] )
 
.controller('memberDetail', function(participant_detail,$state,PopupFactory,$scope,$localstorage,$stateParams,apiUrlLocal) {
  ...
  $scope.contact = participant_detail.get({"contactId": $stateParams.contactId, "dto(addressId)": $stateParams.addressId, "dto(contactPersonId)": $stateParams.contactPersonId, "dto(addressType)":$stateParams.addressType});
